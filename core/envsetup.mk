...
TARGET_COPY_OUT_SDEXT := sd-ext

SDEXT_PREFIX_ROOT := $(TARGET_COPY_OUT_SDEXT)/extapps
...
TARGET_OUT_SDEXT := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_SDEXT)
TARGET_OUT_SDEXT_SYSTEM := $(PRODUCT_OUT)/$(SDEXT_PREFIX_ROOT)/system
TARGET_OUT_SDEXT_EXECUTABLES:= $(TARGET_OUT_SDEXT_SYSTEM)/bin
TARGET_OUT_SDEXT_OPTIONAL_EXECUTABLES:= $(TARGET_OUT_SDEXT_SYSTEM)/xbin
TARGET_OUT_SDEXT_SHARED_LIBRARIES:= $(TARGET_OUT_SDEXT_SYSTEM)/lib
TARGET_OUT_SDEXT_JAVA_LIBRARIES:= $(TARGET_OUT_SDEXT_SYSTEM)/framework
TARGET_OUT_SDEXT_APPS:= $(TARGET_OUT_SDEXT_SYSTEM)/app
TARGET_OUT_SDEXT_APPS_PRIVILEGED := $(TARGET_OUT_SDEXT_SYSTEM)/priv-app
TARGET_OUT_SDEXT_KEYLAYOUT := $(TARGET_OUT_SDEXT_SYSTEM)/usr/keylayout
TARGET_OUT_SDEXT_KEYCHARS := $(TARGET_OUT_SDEXT_SYSTEM)/usr/keychars
TARGET_OUT_SDEXT_ETC := $(TARGET_OUT_SDEXT_SYSTEM)/etc
TARGET_OUT_SDEXT_NOTICE_FILES:=$(TARGET_OUT_INTERMEDIATES)/NOTICE_FILES
TARGET_OUT_SDEXT_FAKE := $(PRODUCT_OUT)/fake_packages
